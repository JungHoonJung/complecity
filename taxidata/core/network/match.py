    ...
    def path_stitching(self, segments):
        ...
        for seg in segments[1:]:
            ...
            if len(start_overlap)>0:
                ...
                shortest_path = nx.shortest_path(road_network, Joint_node[-1], seg.nodes()[0],'length')
        ...
        edge_in = (Joint_node[0],Joint_node[1],0,road_network.get_edge_data(Joint_node[0],Joint_node[1],0))
        Jointsegment = segment(edge_in)
        for edge_count in range(len(Joint_node)-2):
            edge_in = (Joint_node[edge_count+1],Joint_node[edge_count+2],0,road_network.get_edge_data(Joint_node[edge_count+1],Joint_node[edge_count+2],0))
